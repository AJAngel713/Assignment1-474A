...
set rc [catch {
  ...
  set_property ip_repo_paths {{c:/Users/PL/Workspace Git Hub/Assignment1-474A/Assignment1.cache/ip}} [current_project]
  set_property ip_output_repo {{c:/Users/PL/Workspace Git Hub/Assignment1-474A/Assignment1.cache/ip}} [current_project]
  add_files -quiet {{C:/Users/PL/Workspace Git Hub/Assignment1-474A/Assignment1.runs/synth_1/circuit5.dcp}}
  link_design -top circuit5 -part xc7a100tlcsg324-2L
...
set rc [catch {
  ...
  catch {write_hwdef -file circuit5.hwdef}
  place_design 
...
set rc [catch {
  ...
  catch { report_drc -file circuit5_drc_routed.rpt -pb circuit5_drc_routed.pb }
  ...
  catch { report_power -file circuit5_power_routed.rpt -pb circuit5_power_summary_routed.pb }
